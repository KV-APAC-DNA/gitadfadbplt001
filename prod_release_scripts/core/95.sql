create or replace TABLE PCFWKS_INTEGRATION.WKS_NATIONAL_ECOMM_DATA (
	PFC VARCHAR(20),
	SKUNAME VARCHAR(100),
...
truncate table PCFWKS_INTEGRATION.WKS_NATIONAL_ECOMM_DATA;COPY INTO PCFWKS_INTEGRATION.WKS_NATIONAL_ECOMM_DATA FROM '@UTILITY_RAW.PROD_CORE_STAGE_S3/AU_WKS_WKS_NATIONAL_ECOMM_DATAT/' FILE_FORMAT = 'UTILITY_RAW.PROD_CORE_CSV_FILEFORMAT' ;
