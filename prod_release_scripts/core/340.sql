delete from aspitg_integration.itg_pop6_displays;

insert into aspitg_integration.itg_pop6_displays select * from aspitg_integration.itg_pop6_displays_bkp_20240906;
