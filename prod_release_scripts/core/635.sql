delete from PROD_DNA_CORE.DBT_CLOUD_PR_5458_1541.JPNWKS_INTEGRATION__WKS_RETAIL_EXCELLENCE_MSL_TARGET_FINAL;

insert into PROD_DNA_CORE.DBT_CLOUD_PR_5458_1541.JPNWKS_INTEGRATION__WKS_RETAIL_EXCELLENCE_MSL_TARGET_FINAL (
...
rpt_retail_excellence_sop as 
 (
    select * from PROD_DNA_CORE.DBT_CLOUD_PR_5458_1541.JPNWKS_INTEGRATION__WKS_RPT_RETAIL_EXCELLENCE_SOP
 )
   ...
   from 
        ...
        group by 1,2)b 
    inner join 
    (select * from mds_reds_market_msl_target_final where UPPER(market)='JAPAN'
     ) mds 
...
----------
delete from PROD_DNA_CORE.DBT_CLOUD_PR_5458_1541.jpnedw_integration__edw_rpt_retail_excellence;

insert into PROD_DNA_CORE.DBT_CLOUD_PR_5458_1541.jpnedw_integration__edw_rpt_retail_excellence (

with WKS_RPT_RETAIL_EXCELLENCE_SOP as (
    select * from PROD_DNA_CORE.DBT_CLOUD_PR_5458_1541.JPNWKS_INTEGRATION__WKS_RPT_RETAIL_EXCELLENCE_SOP
),
retail_excellence_msl_target_final as (
    select * from PROD_DNA_CORE.DBT_CLOUD_PR_5458_1541.JPNWKS_INTEGRATION__WKS_RETAIL_EXCELLENCE_MSL_TARGET_FINAL
)
    ...
    SELECT DM.FISC_YR,
       ...
       P12M_SALES_FLAG,
       MDP_FLAG,
       --case when mdp_flag='Y' and DM.global_product_brand=target.global_product_brand then target.TARGET_COMPLAINCE else 1 end as TARGET_COMPLAINCE,
