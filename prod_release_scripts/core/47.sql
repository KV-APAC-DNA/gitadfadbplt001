CREATE TABLE ASPWKS_INTEGRATION.WKS_CHINA_REG_INVENTORY_HEALTH_ANALYSIS_PROPAGATION_FINAL (		--// CREATE TABLE ASPWKS_INTEGRATION.wks_china_reg_inventory_health_analysis_propagation_final (
    year numeric(18,0),		--//  ENCODE az64 // integer
    year_quarter varchar(11),		--//  ENCODE lzo // character varying
    month_year varchar(23),		--//  ENCODE lzo // character varying
    mnth_no numeric(18,0),		--//  ENCODE az64 // integer
    country_name varchar(14),		--//  ENCODE lzo // character varying
    sold_to_ref varchar(20),		--//  ENCODE lzo // character varying
    ...
    region varchar(10),		--//  ENCODE lzo // character varying
    zone_or_area varchar(10),		--//  ENCODE lzo // character varying
    ...
    last_3months_so_qty numeric(38,2),		--//  ENCODE az64
    last_6months_so_qty numeric(38,2),		--//  ENCODE az64
    last_12months_so_qty numeric(38,2),		--//  ENCODE az64
...
CREATE TABLE ASPWKS_INTEGRATION.WKS_HK_INVENTORY_HEALTH_ANALYSIS_PROPAGATION_FINAL (		--// CREATE TABLE ASPWKS_INTEGRATION.wks_hk_inventory_health_analysis_propagation_final (
    ...
    sap_bnr_frmt_desc varchar(50),		--//  ENCODE lzo // character varying
    retail_env varchar(50),		--//  ENCODE lzo // character varying
    region varchar(8),		--//  ENCODE lzo // character varying
    zone_or_area varchar(8),		--//  ENCODE lzo // character varying
    si_sls_qty numeric(38,5),		--//  ENCODE az64
    si_gts_val numeric(38,5),		--//  ENCODE az64
    si_gts_val_usd numeric(38,5),		--//  ENCODE az64
    inventory_quantity numeric(38,5),		--//  ENCODE az64
...
CREATE TABLE ASPWKS_INTEGRATION.WKS_INDIA_INVENTORY_HEALTH_ANALYSIS_PROPAGATION_FINAL (		--// CREATE TABLE ASPWKS_INTEGRATION.wks_india_inventory_health_analysis_propagation_final (
    year numeric(18,0),		--//  ENCODE az64 // integer
    year_quarter numeric(18,0),		--//  ENCODE az64 // integer
    month_year varchar(23),		--//  ENCODE lzo // character varying
    month_number numeric(18,0),		--//  ENCODE az64 // integer
    country_name varchar(5),		--//  ENCODE lzo // character varying
    distributor_id varchar(50),		--//  ENCODE lzo // character varying
    distributor_id_name varchar(2),		--//  ENCODE lzo // character varying
    ...
    to_ccy varchar(3),		--//  ENCODE lzo // character varying
    exch_rate numeric(15,5),		--//  ENCODE az64
    sap_prnt_cust_key varchar(50),		--//  ENCODE lzo // character varying
    sap_prnt_cust_desc varchar(102),		--//  ENCODE lzo // character varying
    sap_cust_chnl_key varchar(12),		--//  ENCODE lzo // character varying
    sap_cust_chnl_desc varchar(50),		--//  ENCODE lzo // character varying
    sap_cust_sub_chnl_key varchar(12),		--//  ENCODE lzo // character varying
    sap_sub_chnl_desc varchar(50),		--//  ENCODE lzo // character varying
    ...
    sap_bnr_frmt_desc varchar(50),		--//  ENCODE lzo // character varying
    retail_env varchar(50),		--//  ENCODE lzo // character varying
    region varchar(50),		--//  ENCODE lzo // character varying
    zone_or_area varchar(50),		--//  ENCODE lzo // character varying
    si_sls_qty numeric(38,5),		--//  ENCODE az64
    si_gts_val numeric(38,5),		--//  ENCODE az64
    si_gts_val_usd numeric(38,5),		--//  ENCODE az64
    inventory_quantity numeric(38,5),		--//  ENCODE az64
    ...
    so_grs_trd_sls_usd numeric(31,0),		--//  ENCODE az64
    si_all_db_val numeric(38,5),		--//  ENCODE az64
    si_all_db_val_usd numeric(38,5),		--//  ENCODE az64
    si_inv_db_val numeric(38,5),		--//  ENCODE az64
    si_inv_db_val_usd numeric(38,5),		--//  ENCODE az64
    ...
    last_3months_so_val numeric(38,3),		--//  ENCODE az64
    last_3months_so_val_usd numeric(38,5),		--//  ENCODE az64
    last_6months_so_val numeric(38,3),		--//  ENCODE az64
    last_6months_so_val_usd numeric(38,5),		--//  ENCODE az64
    last_12months_so_val numeric(38,3),		--//  ENCODE az64
    last_12months_so_val_usd numeric(38,5),		--//  ENCODE az64
    propagate_flag varchar(1),		--//  ENCODE lzo // character varying
    propagate_from numeric(18,0),		--//  ENCODE az64 // integer
    reason varchar(100),		--//  ENCODE lzo // character varying
    last_36months_so_val numeric(38,3),		--//  ENCODE az64
    healthy_inventory varchar(1),		--//  ENCODE lzo // character varying
    min_date date,		--//  ENCODE az64
    diff_weeks numeric(38,0),		--//  ENCODE az64 // bigint
    l12m_weeks numeric(38,0),		--//  ENCODE az64 // bigint
...
CREATE TABLE ASPWKS_INTEGRATION.WKS_INDONESIA_INVENTORY_HEALTH_ANALYSIS_PROPAGATION_FINAL (		--// CREATE TABLE ASPWKS_INTEGRATION.wks_indonesia_inventory_health_analysis_propagation_final (
    year numeric(18,0),		--//  ENCODE az64 // integer
    year_quarter varchar(11),		--//  ENCODE lzo // character varying
    month_year varchar(23),		--//  ENCODE lzo // character varying
    month_number numeric(18,0),		--//  ENCODE az64 // integer
    country_name varchar(9),		--//  ENCODE lzo // character varying
    dstrbtr_grp_cd varchar(25),		--//  ENCODE lzo // character varying
    dstrbtr_grp_name varchar(103),		--//  ENCODE lzo // character varying
    franchise varchar(50),		--//  ENCODE lzo // character varying
    brand varchar(50),		--//  ENCODE lzo // character varying
    prod_sub_brand varchar(100),		--//  ENCODE lzo // character varying
    variant varchar(100),		--//  ENCODE lzo // character varying
    segment varchar(50),		--//  ENCODE lzo // character varying
    prod_subsegment varchar(100),		--//  ENCODE lzo // character varying
    ...
    exch_rate numeric(15,5),		--//  ENCODE az64
    sap_prnt_cust_key varchar(12),		--//  ENCODE lzo // character varying
    sap_prnt_cust_desc varchar(155),		--//  ENCODE lzo // character varying
    sap_cust_chnl_key varchar(12),		--//  ENCODE lzo // character varying
    sap_cust_chnl_desc varchar(50),		--//  ENCODE lzo // character varying
    sap_cust_sub_chnl_key varchar(12),		--//  ENCODE lzo // character varying
    sap_sub_chnl_desc varchar(50),		--//  ENCODE lzo // character varying
    ...
    so_sls_qty numeric(38,5),		--//  ENCODE az64
    so_grs_trd_sls numeric(38,5),		--//  ENCODE az64
    so_grs_trd_sls_usd numeric(30,0),		--//  ENCODE az64
    si_all_db_val numeric(38,5),		--//  ENCODE az64
    si_all_db_val_usd numeric(38,5),		--//  ENCODE az64
    si_inv_db_val numeric(38,5),		--//  ENCODE az64
    si_inv_db_val_usd numeric(38,5),		--//  ENCODE az64
...
CREATE TABLE JPNWKS_INTEGRATION.WKS_JAPAN_INVENTORY_HEALTH_ANALYSIS_PROPAGATION (		--// CREATE TABLE JPNWKS_INTEGRATION.wks_japan_inventory_health_analysis_propagation (
    year numeric(18,0),		--//  ENCODE az64 // integer
    year_quarter numeric(18,0),		--//  ENCODE az64 // integer
    month_year numeric(18,0),		--//  ENCODE az64 // integer
    month_number numeric(18,0),		--//  ENCODE az64 // integer
    country_name varchar(5),		--//  ENCODE lzo // character varying
    ...
    prod_category varchar(50),		--//  ENCODE lzo // character varying
    prod_subcategory varchar(50),		--//  ENCODE lzo // character varying
    put_up_description varchar(100),		--//  ENCODE lzo // character varying
    sku_cd varchar(40),		--//  ENCODE lzo // character varying
    sku_description varchar(100),		--//  ENCODE lzo // character varying
    pka_product_key varchar(68),		--//  ENCODE lzo // character varying
    pka_product_key_description varchar(255),		--//  ENCODE lzo // character varying
    ...
    so_sls_qty numeric(38,5),		--//  ENCODE az64
    so_grs_trd_sls numeric(38,5),		--//  ENCODE az64
    so_grs_trd_sls_usd numeric(24,0),		--//  ENCODE az64
    si_all_db_val numeric(38,5),		--//  ENCODE az64
    si_all_db_val_usd numeric(38,5),		--//  ENCODE az64
    si_inv_db_val numeric(38,5),		--//  ENCODE az64
    si_inv_db_val_usd numeric(38,5),		--//  ENCODE az64
    last_3months_so_qty numeric(38,10),		--//  ENCODE az64
    last_6months_so_qty numeric(38,10),		--//  ENCODE az64
    last_12months_so_qty numeric(38,10),		--//  ENCODE az64
    last_3months_so_val numeric(38,10),		--//  ENCODE az64
    last_3months_so_val_usd numeric(38,5),		--//  ENCODE az64
    last_6months_so_val numeric(38,10),		--//  ENCODE az64
    last_6months_so_val_usd numeric(38,5),		--//  ENCODE az64
    last_12months_so_val numeric(38,10),		--//  ENCODE az64
    last_12months_so_val_usd numeric(38,5),		--//  ENCODE az64
    propagate_flag varchar(1),		--//  ENCODE lzo // character varying
    propagate_from numeric(18,0),		--//  ENCODE az64 // integer
    reason varchar(100)		--//  ENCODE lzo // character varying
