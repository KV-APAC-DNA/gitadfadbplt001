...
FROM (
  (
      ...
      (
        (
          (
            ...
            LEFT JOIN ASPEDW_INTEGRATION.edw_acct_ciw_hier AS ciw
              ON (
                (
                  (
                    LTRIM(
          ...
          LEFT JOIN (
            ...
            FROM (
              (
                ...
                FROM ASPEDW_INTEGRATION.edw_account_ciw_dim
                WHERE
                  (
                    (
                      CAST((
    ...
    LEFT JOIN ASPEDW_INTEGRATION.edw_gch_producthierarchy AS gph
      ON (
        (
          CAST((
            fact.matl_num
  ...
  FROM (
    (
      (
        ...
        JOIN ASPEDW_INTEGRATION.edw_company_dim AS cmp
          ON (
            (
              CAST((
                copa.co_cd
  ...
  FROM (
    (
      (
        (
          (
            (
              SELECT
                ASPEDW_INTEGRATION.edw_account_ciw_dim.chrt_acct,
                ASPEDW_INTEGRATION.edw_account_ciw_dim.acct_num,
                ASPEDW_INTEGRATION.edw_account_ciw_dim.acct_nm,
                ASPEDW_INTEGRATION.edw_account_ciw_dim.ciw_acct_l3_txt AS ciw_desc,
                CAST((
                  CASE
                    WHEN (
                      (
                        (
                          (
                            (
                              (
                                SPLIT_PART(CAST((
                                  ASPEDW_INTEGRATION.edw_account_ciw_dim.ciw_acct_l3
                    ...
                    THEN COALESCE(
                      SPLIT_PART(
                        LTRIM(
                          SPLIT_PART(CAST((
                            ASPEDW_INTEGRATION.edw_account_ciw_dim.ciw_acct_l5
                      ...
                      LTRIM(
                        SPLIT_PART(CAST((
                          ASPEDW_INTEGRATION.edw_account_ciw_dim.ciw_acct_l4
                        ) AS TEXT), CAST('_' AS TEXT), 1),
                        CAST('JJPLAC' AS TEXT)
                      )
                    )
                ...
                CASE
                  ...
                  THEN COALESCE(ASPEDW_INTEGRATION.edw_account_ciw_dim.ciw_acct_l5_txt, ASPEDW_INTEGRATION.edw_account_ciw_dim.ciw_acct_l4_txt)
                  ELSE ASPEDW_INTEGRATION.edw_account_ciw_dim.ciw_acct_l4_txt
                END AS ciw_bucket,
                CAST('CIW_ACCT_L1' AS VARCHAR) AS ciw_acct_col,
                ASPEDW_INTEGRATION.edw_account_ciw_dim.ciw_acct_l1 AS ciw_acct_no,
                ASPEDW_INTEGRATION.edw_account_ciw_dim.ciw_acct_l1_txt AS ciw_acct_nm
              FROM ASPEDW_INTEGRATION.edw_account_ciw_dim
              WHERE
                (
                  LENGTH(CAST((
                    ASPEDW_INTEGRATION.edw_account_ciw_dim.ciw_acct_l1
                  ) AS TEXT)) <> 0
                )
              UNION ALL
              SELECT
                ...
                ASPEDW_INTEGRATION.edw_account_ciw_dim.ciw_acct_l2 AS ciw_acct_no,
                ASPEDW_INTEGRATION.edw_account_ciw_dim.ciw_acct_l2_txt AS ciw_acct_nm
              FROM ASPEDW_INTEGRATION.edw_account_ciw_dim
              WHERE
                (
                  LENGTH(CAST((
                    ASPEDW_INTEGRATION.edw_account_ciw_dim.ciw_acct_l2
                  ) AS TEXT)) <> 0
                )
            )
            UNION ALL
            SELECT
              ...
              ASPEDW_INTEGRATION.edw_account_ciw_dim.ciw_acct_l3 AS ciw_acct_no,
              ASPEDW_INTEGRATION.edw_account_ciw_dim.ciw_acct_l3_txt AS ciw_acct_nm
            FROM ASPEDW_INTEGRATION.edw_account_ciw_dim
            WHERE
              (
                LENGTH(CAST((
          ...
          SELECT
            ...
            ASPEDW_INTEGRATION.edw_account_ciw_dim.ciw_acct_l4 AS ciw_acct_no,
            ASPEDW_INTEGRATION.edw_account_ciw_dim.ciw_acct_l4_txt AS ciw_acct_nm
          FROM ASPEDW_INTEGRATION.edw_account_ciw_dim
          WHERE
            (
              LENGTH(CAST((
        ...
        SELECT
          ...
          ASPEDW_INTEGRATION.edw_account_ciw_dim.ciw_acct_l5 AS ciw_acct_no,
          ASPEDW_INTEGRATION.edw_account_ciw_dim.ciw_acct_l5_txt AS ciw_acct_nm
        FROM ASPEDW_INTEGRATION.edw_account_ciw_dim
        WHERE
          (
            LENGTH(CAST((
      ...
      SELECT
        ...
        ASPEDW_INTEGRATION.edw_account_ciw_dim.ciw_acct_l6 AS ciw_acct_no,
        ASPEDW_INTEGRATION.edw_account_ciw_dim.ciw_acct_l6_txt AS ciw_acct_nm
      FROM ASPEDW_INTEGRATION.edw_account_ciw_dim
      WHERE
        (
          LENGTH(CAST((
            ASPEDW_INTEGRATION.edw_account_ciw_dim.ciw_acct_l6
          ) AS TEXT)) <> 0
        )
    ) AS a
