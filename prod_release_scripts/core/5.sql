create or replace TABLE DEV_DNA_CORE.ASPITG_INTEGRATION.ITG_COPA_TRANS (
...
create or replace TABLE DEV_DNA_CORE.ASPITG_INTEGRATION.ITG_INVNT (
...
create or replace TABLE DEV_DNA_CORE.ASPITG_INTEGRATION.ITG_COPA17_TRANS (
	REQUEST_NUMBER VARCHAR(100) NOT NULL,
	DATA_PACKET VARCHAR(50) NOT NULL,
	DATA_RECORD VARCHAR(100) NOT NULL,
...
create or replace TABLE DEV_DNA_CORE.ASPITG_INTEGRATION.ITG_INVC_SLS (
	REQUEST_NUMBER VARCHAR(100) NOT NULL,
	DATA_PACKET VARCHAR(50) NOT NULL,
	DATA_RECORD VARCHAR(100) NOT NULL,
	ACT_DELV_DT DATE,
...
create or replace TABLE DEV_DNA_CORE.ASPITG_INTEGRATION.ITG_RG_TRAVEL_RETAIL_SELLOUT (
	CTRY_CD VARCHAR(2),
	CRNCY_CD VARCHAR(3),
