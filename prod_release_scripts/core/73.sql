...
COPY INTO SNAPOSEITG_INTEGRATION.ITG_MY_SELLOUT_SALES_FACT_backup FROM '@UTILITY_RAW.PROD_CORE_STAGE_S3/OS_ITG_ITG_MY_SELLOUT_SALES_FACT/' FILE_FORMAT = 'UTILITY_RAW.DEV_CORE_CSV_FILEFORMAT' ;
