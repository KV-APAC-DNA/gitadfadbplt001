delete from PROD_DNA_CORE.DBT_CLOUD_PR_5458_1220.ASPEDW_INTEGRATION__EDW_RPT_REGIONAL_SELLOUT_OFFTAKE where country_code = 'PH';
...
(
	 select * from PROD_DNA_CORE.DBT_CLOUD_PR_5458_1220.PHLWKS_INTEGRATION__WKS_RPT_REGIONAL_PH_SELLOUT_OFFTAKE_NPD
),
