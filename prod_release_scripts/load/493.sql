INSERT INTO PROD_DNA_LOAD.META_RAW.SOURCE (SOURCE_ID, SOURCE_NAME,SOURCE_TYPE,FREQUENCY) VALUES (8,'ODBC','ODBC Server','');

INSERT INTO PROD_DNA_LOAD.META_RAW.USECASE (USECASE_ID, USECASE_NAME,CATEGORY,USECASE_DESCRIPTION,IS_ACTIVE,SEQUENCE_ID) VALUES (501,'OTIF_Data_Ingestion','OTIF_D_Data_Load','OTIF  Data Ingestion','TRUE',1);

INSERT INTO PROD_DNA_LOAD.META_RAW.PARAMETERS (PARAMETER_ID, PARAMETER_GROUP_ID,PARAMETER_GROUP_NAME,PARAMETER_NAME,PARAMETER_VALUE,IS_SENSITIVE,IS_ACTIVE) VALUES (25001,2001,'OTIFD_Data_Ingestion','container','asp',FALSE,TRUE);
INSERT INTO PROD_DNA_LOAD.META_RAW.PARAMETERS (PARAMETER_ID, PARAMETER_GROUP_ID,PARAMETER_GROUP_NAME,PARAMETER_NAME,PARAMETER_VALUE,IS_SENSITIVE,IS_ACTIVE) VALUES (25002,2001,'OTIFD_Data_Ingestion','landing_file_path','dev/transaction/',FALSE,TRUE);
INSERT INTO PROD_DNA_LOAD.META_RAW.PARAMETERS (PARAMETER_ID, PARAMETER_GROUP_ID,PARAMETER_GROUP_NAME,PARAMETER_NAME,PARAMETER_VALUE,IS_SENSITIVE,IS_ACTIVE) VALUES (25003,2001,'OTIFD_Data_Ingestion','landing_file_name','otif_cnsmr_attr_detl',FALSE,TRUE);
INSERT INTO PROD_DNA_LOAD.META_RAW.PARAMETERS (PARAMETER_ID, PARAMETER_GROUP_ID,PARAMETER_GROUP_NAME,PARAMETER_NAME,PARAMETER_VALUE,IS_SENSITIVE,IS_ACTIVE) VALUES (25004,2001,'OTIFD_Data_Ingestion','target_table','SDL_OTIF_CONSUMER_ATTR',FALSE,TRUE);
INSERT INTO PROD_DNA_LOAD.META_RAW.PARAMETERS (PARAMETER_ID, PARAMETER_GROUP_ID,PARAMETER_GROUP_NAME,PARAMETER_NAME,PARAMETER_VALUE,IS_SENSITIVE,IS_ACTIVE) VALUES (25005,2001,'OTIFD_Data_Ingestion','target_schema','OTIFCOUNSUMER_RAW',FALSE,TRUE);
INSERT INTO PROD_DNA_LOAD.META_RAW.PARAMETERS (PARAMETER_ID, PARAMETER_GROUP_ID,PARAMETER_GROUP_NAME,PARAMETER_NAME,PARAMETER_VALUE,IS_SENSITIVE,IS_ACTIVE) VALUES (25006,2001,'OTIFD_Data_Ingestion','truncate_and_load','Y',FALSE,TRUE);
INSERT INTO PROD_DNA_LOAD.META_RAW.PARAMETERS (PARAMETER_ID, PARAMETER_GROUP_ID,PARAMETER_GROUP_NAME,PARAMETER_NAME,PARAMETER_VALUE,IS_SENSITIVE,IS_ACTIVE) VALUES (25007,2001,'OTIFD_Data_Ingestion','decide_source','Odbc_databricks_adfadbplt001lsazrwbudbx',FALSE,TRUE);
INSERT INTO PROD_DNA_LOAD.META_RAW.PARAMETERS (PARAMETER_ID, PARAMETER_GROUP_ID,PARAMETER_GROUP_NAME,PARAMETER_NAME,PARAMETER_VALUE,IS_SENSITIVE,IS_ACTIVE) VALUES (25008,2001,'OTIFD_Data_Ingestion','ms_query','SELECT * from delv.otif_d_cnsmr_attr_detl 
WHERE CAST(FISC_YR_NBR AS INT) >= YEAR(GETDATE()) 
AND CAST((SUBSTRING(FISC_YR_MO_NUM,6,2))AS INT)>
(MONTH(GETDATE())-3);',FALSE,TRUE);

INSERT INTO PROD_DNA_LOAD.META_RAW.PROCESS VALUES (2001,2001,'OTIFD_Data_Ingestion',2001,1,1,FALSE,TRUE,501,8,1,null,'','','','ASPSDL_RAW.DEV_LOAD_STAGE_ADLS','','');

INSERT INTO PROD_DNA_LOAD.META_RAW.PIPELINE_TYPE (PIPELINE_TYPE_ID,PIPELINE_TYPE_NAME,PIPELINE_TYPE_DESC,IS_ACTIVE) VALUES (2001,'OTIF_ING','OTIFD Ingestion',TRUE);
