...
CREATE TABLE IF NOT EXISTS SDL_ACCT_NIELSENCODE_MAPPING (
...
CREATE TABLE IF NOT EXISTS SDL_API_DSTR (
	INVT_DT VARCHAR(50),
...
CREATE TABLE IF NOT EXISTS SDL_AU_DSTR_API_HEADER (
	ARTICLE_ID VARCHAR(50),
	ARTICLE_DESC VARCHAR(100),
	PRODUCT_EAN VARCHAR(50),
	SITE_ID VARCHAR(50),
...
CREATE TABLE IF NOT EXISTS SDL_AU_DSTR_CHS_HEADER (
...
CREATE TABLE IF NOT EXISTS SDL_AU_DSTR_SIGMA_HEADER (
...
CREATE TABLE IF NOT EXISTS SDL_AU_DSTR_SYMBION_HEADER (
	STATE VARCHAR(100),
	WAREHOUSE VARCHAR(100),
...
CREATE TABLE IF NOT EXISTS SDL_CHS_DSTR (
	INV_DT VARCHAR(30),
...
CREATE TABLE IF NOT EXISTS SDL_CHW_ECOMM_DATA (
	PFC VARCHAR(20),
	SKUNAME VARCHAR(100),
...
CREATE TABLE IF NOT EXISTS SDL_COMPETITIVE_BANNER_GROUP (
	MARKET VARCHAR(2000),
	BANNER VARCHAR(2000),
...
CREATE TABLE IF NOT EXISTS SDL_DSTR_COLES_INV (
	VENDOR VARCHAR(50),
...
CREATE TABLE IF NOT EXISTS SDL_DSTR_WOOLWORTH_INV (
	INV_DATE VARCHAR(20),
	RANK VARCHAR(10),
...
CREATE TABLE IF NOT EXISTS SDL_IG_INVENTORY_DATA (
	INV_DT VARCHAR(100),
	STATE VARCHAR(100),
...
CREATE TABLE IF NOT EXISTS SDL_IRI_SCAN_SALES (
...
CREATE TABLE IF NOT EXISTS SDL_MDS_PACIFIC_ACCT_NIELSENCODE_MAPPING (
	ID NUMBER(18,0),
	MUID VARCHAR(36),
...
CREATE TABLE IF NOT EXISTS SDL_MDS_PACIFIC_CIW_ADJUSTMENT (
	ID NUMBER(18,0),
	MUID VARCHAR(36),
	VERSIONNAME VARCHAR(100),
	VERSIONNUMBER NUMBER(18,0),
...
CREATE TABLE IF NOT EXISTS SDL_MDS_PACIFIC_COGS_MASTER (
...
CREATE TABLE IF NOT EXISTS SDL_MDS_PACIFIC_CUST_ATTRB (
	CHANGETRACKINGMASK NUMBER(18,0),
	CODE VARCHAR(500),
	ENTERDATETIME TIMESTAMP_NTZ(9),
	ENTERUSERNAME VARCHAR(200),
...
CREATE TABLE IF NOT EXISTS SDL_MDS_PACIFIC_CUST_CIW_PLAN (
	ID NUMBER(18,0),
	MUID VARCHAR(36),
	VERSIONNAME VARCHAR(100),
	VERSIONNUMBER NUMBER(18,0),
...
CREATE TABLE IF NOT EXISTS SDL_MDS_PACIFIC_ECOM_NTS (
	ID NUMBER(18,0),
	MUID VARCHAR(36),
	VERSIONNAME VARCHAR(100),
	VERSIONNUMBER NUMBER(18,0),
...
CREATE TABLE IF NOT EXISTS SDL_MDS_PACIFIC_ECOM_PRODUCT (
	ID NUMBER(18,0),
	MUID VARCHAR(36),
	VERSIONNAME VARCHAR(100),
	VERSIONNUMBER NUMBER(18,0),
...
CREATE TABLE IF NOT EXISTS SDL_MDS_PACIFIC_PERENSO_CYCLE_DATES (
	ID NUMBER(18,0),
	MUID VARCHAR(36),
	VERSIONNAME VARCHAR(100),
	VERSIONNUMBER NUMBER(18,0),
...
CREATE TABLE IF NOT EXISTS SDL_MDS_PACIFIC_PRODUCT_MAPPING_COLES (
	ID NUMBER(18,0),
	MUID VARCHAR(36),
	VERSIONNAME VARCHAR(100),
	VERSIONNUMBER NUMBER(18,0),
...
CREATE TABLE IF NOT EXISTS SDL_MDS_PACIFIC_PRODUCT_MAPPING_WW (
	ID NUMBER(18,0),
	MUID VARCHAR(36),
	VERSIONNAME VARCHAR(100),
	VERSIONNUMBER NUMBER(18,0),
...
CREATE TABLE IF NOT EXISTS SDL_MDS_PACIFIC_PS_MSL (
	ID NUMBER(18,0),
	MUID VARCHAR(36),
	VERSIONNAME VARCHAR(100),
	VERSIONNUMBER NUMBER(18,0),
...
CREATE TABLE IF NOT EXISTS SDL_MDS_PACIFIC_PS_TARGETS (
	CHANGETRACKINGMASK NUMBER(18,0),
	CODE VARCHAR(500),
	ENTERDATETIME TIMESTAMP_NTZ(9),
	ENTERUSERNAME VARCHAR(200),
...
CREATE TABLE IF NOT EXISTS SDL_MDS_PACIFIC_PS_WEIGHTS (
	CHANGETRACKINGMASK NUMBER(18,0),
	CODE VARCHAR(500),
	CTRY VARCHAR(510),
...
CREATE TABLE IF NOT EXISTS SDL_MDS_PACIFIC_PX_GL_CIW_MAPPING (
	ID NUMBER(18,0),
	MUID VARCHAR(36),
	VERSIONNAME VARCHAR(100),
	VERSIONNUMBER NUMBER(18,0),
...
CREATE TABLE IF NOT EXISTS SDL_MDS_PACIFIC_SAPBW_PLAN_LKP (
	CHANGETRACKINGMASK NUMBER(18,0),
	CODE VARCHAR(500),
	ENTERDATETIME TIMESTAMP_NTZ(9),
	ENTERUSERNAME VARCHAR(200),
...
CREATE TABLE IF NOT EXISTS SDL_MDS_PACIFIC_SAP_GL_CIW_MAPPING (
	ID NUMBER(18,0),
	MUID VARCHAR(36),
	VERSIONNAME VARCHAR(100),
	VERSIONNUMBER NUMBER(18,0),
...
CREATE TABLE IF NOT EXISTS SDL_MDS_PACIFIC_SKU_BENCHMARKS (
	ID NUMBER(18,0),
	MUID VARCHAR(36),
	VERSIONNAME VARCHAR(100),
	VERSIONNUMBER NUMBER(18,0),
...
CREATE TABLE IF NOT EXISTS SDL_MDS_PACIFIC_TERMS_MASTER (
	CHANGETRACKINGMASK NUMBER(18,0),
	CODE VARCHAR(500),
	COUNTRY VARCHAR(200),
	ENTERDATETIME TIMESTAMP_NTZ(9),
...
CREATE TABLE IF NOT EXISTS SDL_METCASH_IND_GROCERY (
	SUPP_ID VARCHAR(20),
...
CREATE TABLE IF NOT EXISTS SDL_NATIONAL_ECOMM_DATA (
	PFC VARCHAR(20),
	SKUNAME VARCHAR(100),
	NEC1_DESC VARCHAR(100),
	NEC2_DESC VARCHAR(100),
...
CREATE TABLE IF NOT EXISTS SDL_OVER_AND_ABOVE_POINTS (
...
CREATE TABLE IF NOT EXISTS SDL_PACIFIC_PERENSO_CALL_COVERAGE_TARGETS (
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_ACCOUNT (
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_ACCOUNT_CUSTOM_LIST (
	ACCT_KEY NUMBER(10,0),
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_ACCOUNT_FIELDS (
	FIELD_KEY NUMBER(10,0),
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_ACCOUNT_GROUP (
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_ACCOUNT_GROUP_LVL (
	ACCT_GRP_LEV_KEY NUMBER(10,0),
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_ACCOUNT_GROUP_RELN (
	ACCT_KEY NUMBER(10,0),
	ACCT_GRP_KEY NUMBER(10,0),
	RUN_ID NUMBER(14,0),
	CREATE_DT TIMESTAMP_NTZ(9) DEFAULT CONVERT_TIMEZONE('SGT', CAST(CAST('CURRENT_TIMESTAMP()' AS TIMESTAMP_NTZ(9)) AS TIMESTAMP_TZ(9)))
);
CREATE TABLE IF NOT EXISTS SDL_PERENSO_ACCOUNT_RELN_ID (
	ACCT_KEY NUMBER(10,0),
	FIELD_KEY NUMBER(10,0),
	ID VARCHAR(100),
	RUN_ID NUMBER(14,0),
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_ACCOUNT_TYPE (
	ACCT_TYPE_KEY NUMBER(10,0),
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_ACCT_DIST_ACCT (
	ACCT_KEY NUMBER(10,0),
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_CALL_OBJECTIVES (
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_CONSTANTS (
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_DEAL_DISCOUNT (
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_DIARY_ITEM (
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_DIARY_ITEM_TIME (
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_DIARY_ITEM_TYPE (
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_DISTRIBUTOR_DETAIL (
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_FSNI_SALES (
	SITE VARCHAR(100),
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_FSSI_SALES (
	ARTICLE VARCHAR(30),
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_HEAD_OFFICE_REQ_CHECK (
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_HEAD_OFFICE_REQ_STATE (
	ACCT_KEY NUMBER(10,0),
	TODO_KEY NUMBER(10,0),
	PROD_GRP_KEY NUMBER(10,0),
	START_DATE VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_ORDER_BATCH (
	ORD_KEY NUMBER(10,0),
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_ORDER_DETAIL (
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_ORDER_HEADER (
	ORDER_KEY NUMBER(10,0),
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_ORDER_TYPE (
	ORDER_TYPE_KEY NUMBER(10,0),
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_OVER_AND_ABOVE (
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_OVER_AND_ABOVE_STATE (
	OVER_AND_ABOVE_KEY NUMBER(10,0),
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_PRODUCT (
	PROD_KEY NUMBER(10,0),
	PROD_ID VARCHAR(50),
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_PRODUCT_FIELDS (
	FIELD_KEY NUMBER(10,0),
	FIELD_DESC VARCHAR(100),
	FIELD_TYPE NUMBER(10,0),
	ACTIVE VARCHAR(10),
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_PRODUCT_GROUP (
	PROD_GRP_KEY NUMBER(10,0),
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_PRODUCT_GROUP_LVL (
	PROD_GRP_LEV_KEY NUMBER(10,0),
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_PRODUCT_GROUP_RELN (
	PROD_KEY NUMBER(10,0),
	PROD_GRP_KEY NUMBER(10,0),
	RUN_ID NUMBER(14,0),
	CREATE_DT TIMESTAMP_NTZ(9) DEFAULT CONVERT_TIMEZONE('SGT', CAST(CAST('CURRENT_TIMESTAMP()' AS TIMESTAMP_NTZ(9)) AS TIMESTAMP_TZ(9)))
);
CREATE TABLE IF NOT EXISTS SDL_PERENSO_PRODUCT_RELN_ID (
	PROD_KEY NUMBER(10,0),
	FIELD_KEY NUMBER(10,0),
	ID VARCHAR(100),
	RUN_ID NUMBER(14,0),
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_PROD_BRANCH_IDENTIFIER (
	PROD_KEY NUMBER(10,0),
	BRANCH_KEY NUMBER(10,0),
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_PROD_CHK_DISTRIBUTION (
	ACCT_KEY NUMBER(10,0),
	PROD_KEY NUMBER(10,0),
	START_DATE VARCHAR(100),
	END_DATE VARCHAR(100),
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_RANGING (
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_RANGING_ACCT_GRP_REL (
	RANGING_KEY NUMBER(10,0),
	ACCT_GRP_KEY NUMBER(10,0),
	RUN_ID NUMBER(14,0),
	CREATE_DT TIMESTAMP_NTZ(9) DEFAULT CONVERT_TIMEZONE('SGT', CAST(CAST('CURRENT_TIMESTAMP()' AS TIMESTAMP_NTZ(9)) AS TIMESTAMP_TZ(9)))
);
CREATE TABLE IF NOT EXISTS SDL_PERENSO_RANGING_PRODUCT (
	RANGING_KEY NUMBER(10,0),
	PROD_KEY NUMBER(10,0),
	ACCT_GRP_KEY NUMBER(10,0),
	CORE VARCHAR(5),
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_STORE_CHK_HDR (
	STORE_CHK_HDR_KEY NUMBER(10,0),
	DIARY_ITEM_KEY NUMBER(10,0),
	ACCT_KEY NUMBER(10,0),
	WORK_ITEM_KEY NUMBER(10,0),
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_SURVEY_RESULT (
	STORE_CHK_HDR_KEY NUMBER(10,0),
	LINE_KEY NUMBER(10,0),
	TODO_KEY NUMBER(10,0),
	PROD_GRP_KEY NUMBER(10,0),
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_TODO (
	TODO_KEY NUMBER(10,0),
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_TODO_OPTION (
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_USERS (
...
CREATE TABLE IF NOT EXISTS SDL_PERENSO_WORK_ITEM (
	WORK_ITEM_KEY NUMBER(10,0),
...
CREATE TABLE IF NOT EXISTS SDL_PHARMACY_MSL_ITEMS (
	PROD_NUM VARCHAR(30),
	CATEGORY VARCHAR(30),
	EAN VARCHAR(20),
	PROD_DESC VARCHAR(100),
...
CREATE TABLE IF NOT EXISTS SDL_PHARM_SELLOUT_PROBE (
	WEEKENDINGDATE VARCHAR(8),
	OUTLETNUMBER VARCHAR(10),
	PFC VARCHAR(10),
	UNITS NUMBER(18,0),
...
CREATE TABLE IF NOT EXISTS SDL_PHARM_SELLOUT_PRODUCT (
	WEEKENDINGDATE VARCHAR(8),
	PFC VARCHAR(10),
...
CREATE TABLE IF NOT EXISTS SDL_PX_APN (
	SKU_APNCODE VARCHAR(18),
	APN NUMBER(38,0),
	SKU_STOCKCODE VARCHAR(18)
);
CREATE TABLE IF NOT EXISTS SDL_PX_FORECAST (
	AC_CODE VARCHAR(10),
...
CREATE TABLE IF NOT EXISTS SDL_PX_LISTPRICE (
	SKU_STOCKCODE VARCHAR(18) NOT NULL,
	LP_PRICE FLOAT,
	LP_COST FLOAT,
	LP_SALESTAX FLOAT,
...
CREATE TABLE IF NOT EXISTS SDL_PX_MASTER (
	AC_CODE VARCHAR(50),
...
CREATE TABLE IF NOT EXISTS SDL_PX_SCAN_DATA (
...
CREATE TABLE IF NOT EXISTS SDL_PX_TERM_ACTUAL (
...
CREATE TABLE IF NOT EXISTS SDL_PX_TERM_PLAN (
	AC_CODE VARCHAR(50) NOT NULL,
	AC_ATTRIBUTE VARCHAR(20) NOT NULL,
	AC_LONGNAME VARCHAR(40) NOT NULL,
	SKU_STOCKCODE VARCHAR(18) NOT NULL,
...
CREATE TABLE IF NOT EXISTS SDL_PX_UOM (
	SKU_LONGNAME VARCHAR(40) NOT NULL,
	SKU_STOCKCODE VARCHAR(18) NOT NULL,
	SKU_UOM VARCHAR(3),
...
CREATE TABLE IF NOT EXISTS SDL_PX_WEEKLY_SELL (
...
CREATE TABLE IF NOT EXISTS SDL_SIGMA_DSTR (
...
CREATE TABLE IF NOT EXISTS SDL_SURVEY_PRODUCT_GRP_TO_CATEGORY_MAP (
	CATEGORY VARCHAR(256),
	QUESTION_PRODUCT_GROUP VARCHAR(256),
	RUN_ID NUMBER(14,0),
	CREATE_DT TIMESTAMP_NTZ(9) DEFAULT CONVERT_TIMEZONE('SGT', CAST(CAST('CURRENT_TIMESTAMP()' AS TIMESTAMP_NTZ(9)) AS TIMESTAMP_TZ(9)))
);
CREATE TABLE IF NOT EXISTS SDL_SURVEY_TARGETS (
	YEAR VARCHAR(256),
	CYCLE_START_DATE VARCHAR(256),
	CYCLE_END_DATE VARCHAR(256),
	ACCOUNT_TYPE_DESCRIPTION VARCHAR(256),
...
CREATE TABLE IF NOT EXISTS SDL_SURVEY_TYPE_TO_QUESTION_MAP (
	ACCOUNT_TYPE_DESCRIPTION VARCHAR(256),
	TARGET_TYPE VARCHAR(256),
	PERENSO_QUESTIONS VARCHAR(256),
	RUN_ID NUMBER(14,0),
...
CREATE TABLE IF NOT EXISTS SDL_SYMBION_DSTR (
	INV_DT VARCHAR(50),
	STATE VARCHAR(100),
	WAREHOUSE VARCHAR(255),
	WAREHOUSE_DESC VARCHAR(255),
...
CREATE TABLE IF NOT EXISTS SDL_TRAX_FCT_PSD_KPIS (
...
CREATE TABLE IF NOT EXISTS SDL_TRAX_MD_PRODUCT (
	DATASOURCE VARCHAR(124),
...
CREATE TABLE IF NOT EXISTS SDL_TRAX_MD_STORE (
	DATASOURCE VARCHAR(124),
	BUSINESSUNITID VARCHAR(8),
	METAREQUESTSTRING VARCHAR(2048),
	FETCHEDDATETIME TIMESTAMP_NTZ(9),
...
CREATE TABLE IF NOT EXISTS SDL_WEEKLY_FORECAST (
	...
	VERSION VARCHAR(3),
	VTYPE VARCHAR(3),
	JNJ_FISCAL_WEEK VARCHAR(256),
	BASE_UOM VARCHAR(3),
	DOC_CURRCY VARCHAR(5),
	SNAP_DT VARCHAR(256),
	SNAP_WK VARCHAR(6),
	JNJ_FISCAL_YR VARCHAR(6),
	PLANT VARCHAR(4),
	PROD_MNR VARCHAR(18),
	OPR_GRP VARCHAR(18),
	FRAN_GRP VARCHAR(18),
	...
	BASE_FC VARCHAR(17),
	CNBLEFCT VARCHAR(17),
	TOT_FOR_VAL VARCHAR(17),
	COR_DMD_HIST VARCHAR(17),
	CPFR_FCST VARCHAR(17),
	DPNDNT_HIS VARCHAR(17),
	DMD_HIS VARCHAR(17),
	HIS_SHIP VARCHAR(17),
	MAPE001 VARCHAR(17),
	MAPE002 VARCHAR(17),
	...
	MAPE004 VARCHAR(17),
	MAPE005 VARCHAR(17),
	NON_AF_FCST VARCHAR(17),
	OTHMISI VARCHAR(17),
	PRICE_CHNG VARCHAR(17),
	PROMO VARCHAR(17),
	FIN_PROP_FCT VARCHAR(17),
	FIN_PROP_FAC_TBD VARCHAR(17),
	PROP_FACT_TBD VARCHAR(17),
	SAM_FREE_FCT VARCHAR(17),
	TOT_MK_SLS_EVENTS VARCHAR(17),
	TOT_FORECAST VARCHAR(17),
	TOT_BAS_FCT VARCHAR(17),
	NET_FCT VARCHAR(17),
	TRD_INVC VARCHAR(17),
	UNIT_PRC_SKU VARCHAR(17),
	AUX02 VARCHAR(17),
	PROP_FACT VARCHAR(17),
	FIX_PROP_FACT VARCHAR(17),
	HIS_SAL_ORD VARCHAR(17),
	APO_COR_HIST VARCHAR(17),
	PRD_DISC VARCHAR(17),
	FINAL_STAT_FC VARCHAR(17),
	SNCFCST VARCHAR(17),
	TOTNOAFC VARCHAR(17)
);
