CREATE OR REPLACE PROCEDURE DEV_DNA_LOAD.INDSDL_RAW.SDL_LIDAR_FF_OTH_PAID_MEDIA("PARAM" ARRAY)
...
CREATE OR REPLACE PROCEDURE DEV_DNA_LOAD.INDSDL_RAW.SDL_LIDAR_FF_TV_SPENDS("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
CREATE OR REPLACE PROCEDURE DEV_DNA_LOAD.INDSDL_RAW.SDL_LIDAR_FF_TV_GRP("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
