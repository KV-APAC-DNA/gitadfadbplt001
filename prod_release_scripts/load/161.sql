CREATE OR REPLACE FILE FORMAT THASDL_RAW.CSV_FILEFORMAT_PIPE
TYPE = 'CSV'
FIELD_DELIMITER = '|'
FIELD_OPTIONALLY_ENCLOSED_BY = '\"';

CREATE OR REPLACE FILE FORMAT THASDL_RAW.FORMAT1
TYPE = 'CSV'
FIELD_DELIMITER = ';'
FIELD_OPTIONALLY_ENCLOSED_BY = '\"';
...
def main(session: snowpark.Session, Param): 
    ...
    try:
        ...
        final_df.write.copy_into_location("@"+stage_name+"/"+temp_stage_path+"/"+"processed/success/"+formatted_year+"/"+formatted_month+"/"+file_name,header=True,OVERWRITE=True,file_format_name="CSV_FILEFORMAT_PIPE")
