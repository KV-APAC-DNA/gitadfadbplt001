create table PROD_DNA_LOAD.HCPOSESDL_RAW.SDL_HCP_OSEA_SAMPLE_TRANSACTION_12112024_2023 as select * from PROD_DNA_LOAD.HCPOSESDL_RAW.SDL_HCP_OSEA_SAMPLE_TRANSACTION;
...
JJ_LegacyID__c
FROM
    Sample_Transaction_vod__c where CALENDAR_YEAR(CreatedDate ) = 2024'
...
update prod_dna_load.meta_raw.parameters
set PARAMETER_VALUE='AND LastModifiedDate>={WATERMARK_VALUE}'
where parameter_group_id=2225 and PARAMETER_NAME='incremental_filter';
