create table PROD_DNA_LOAD.HCPOSESDL_RAW.SDL_HCP_OSEA_SAMPLE_TRANSACTION_12112024_2021 as select * from PROD_DNA_LOAD.HCPOSESDL_RAW.SDL_HCP_OSEA_SAMPLE_TRANSACTION;
...
JJ_LegacyID__c
FROM
    Sample_Transaction_vod__c where CALENDAR_YEAR(CreatedDate ) = 2022'
...
where parameter_group_id=2225 and PARAMETER_NAME='truncate_and_load';

update prod_DNA_LOAD.META_RAW.PROCESS
set is_incremental='FALSE'
where parameter_group_id=2230;

delete from prod_dna_load.meta_raw.parameters
where parameter_group_id=2230 and PARAMETER_NAME='next_incremental_value';
delete from prod_dna_load.meta_raw.parameters
where parameter_group_id=2230 and PARAMETER_NAME='incremental_filter';
