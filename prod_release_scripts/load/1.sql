...
CREATE TABLE IF NOT EXISTS meta_raw.s3_to_adls (
    id             INTEGER,
    group_id       INTEGER,
    country        STRING,
    s3_bucket      STRING,
...
INSERT INTO meta_raw.s3_to_adls(id,group_id,country,s3_bucket,s3_path,s3_file,adls_container,adls_path,Isactive) VALUES (17,2,'SG','itx-arm-conapdna-metadata-prod','ap_sg_metadata/master/sellout/','ciw_map','sgp','prd/master/sellout',True);
INSERT INTO meta_raw.s3_to_adls(id,group_id,country,s3_bucket,s3_path,s3_file,adls_container,adls_path,Isactive) VALUES (18,2,'SG','itx-arm-conapdna-metadata-prod','ap_sg_metadata/master/sellout/','SG_Zuellig_Customer_Mapping','sgp','prd/master/sellout',True);
INSERT INTO meta_raw.s3_to_adls(id,group_id,country,s3_bucket,s3_path,s3_file,adls_container,adls_path,Isactive) VALUES (19,2,'SG','itx-arm-conapdna-metadata-prod','ap_sg_metadata/master/sellout/','SG_Zuellig_Product_Mapping','sgp','prd/master/sellout',True);
INSERT INTO meta_raw.s3_to_adls(id,group_id,country,s3_bucket,s3_path,s3_file,adls_container,adls_path,Isactive) VALUES (20,2,'SG','itx-arm-conapdna-metadata-prod','ap_sg_metadata/transaction/sellout/','SG_Zuellig_Sell_Out','sgp','prd/transaction/sellout',True);
