...
INSERT INTO META_RAW.PROCESS VALUES (2004,2004,'KR_MDS_Refresh_SDL_MDS_KR_Product_Attribute',2004,1,1,FALSE,TRUE,242,5,1,NULL,'','','','NTASDL_RAW.DEV_LOAD_STAGE_ADLS_KOR','','','');
INSERT INTO META_RAW.PROCESS VALUES (2005,2004,'KR_MDS_Refresh_SDL_MDS_KR_Product_Attribute_1',2005,1,1,FALSE,TRUE,254,5,1,NULL,'','','','NTASDL_RAW.DEV_LOAD_STAGE_ADLS_KOR','','','');
INSERT INTO META_RAW.PROCESS VALUES (2006,2004,'KR_MDS_Refresh_SDL_MDS_KR_Product_Attribute_2',2006,1,1,FALSE,TRUE,271,5,1,NULL,'','','','NTASDL_RAW.DEV_LOAD_STAGE_ADLS_KOR','','','');
...
create or replace TABLE DEV_DNA_LOAD.NTASDL_RAW.SDL_MDS_KR_SUB_CUSTOMER_MASTER (
	ID NUMBER(18,0),
	MUID VARCHAR(100),
...
create or replace TABLE DEV_DNA_LOAD.NTASDL_RAW.SDL_MDS_KR_PRODUCT_ATTRIBUTE (
	ID NUMBER(10,0),
	MUID VARCHAR(40),
	VERSIONNAME VARCHAR(100),
