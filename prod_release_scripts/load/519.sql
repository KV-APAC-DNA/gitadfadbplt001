update meta_raw.parameters set parameter_value='sdl_kr_sfmc_naver_data_additional:sdl_kr_sfmc_naver_data' where parameter_id=7488;
INSERT INTO meta_raw.PARAMETERS (PARAMETER_ID, PARAMETER_GROUP_ID,PARAMETER_GROUP_NAME,PARAMETER_NAME,PARAMETER_VALUE,IS_SENSITIVE,IS_ACTIVE) VALUES (20843,620,'kr_sfmc_naver_data','is_truncate','Y',FALSE,TRUE);
