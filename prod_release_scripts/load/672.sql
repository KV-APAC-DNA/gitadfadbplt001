...
def main(session: snowpark.Session,Param): 
    ...
    try:
        ...
        dataframe = dataframe.filter((dataframe["SHIP_TO_STORE"] != "Result"))
        dataframe = dataframe.filter(~(dataframe["ARTICLE"].isNull() & 
                               dataframe["ARTICLE_DESCRIPTION"].isNull() & 
                               dataframe["OLD_ARTICLE_NUM"].isNull() & 
                               dataframe["EAN"].isNull() & 
                               dataframe["GROSS_WEIGHT"].isNull() & 
                               dataframe["SHIP_TO_STORE"].isNull() & 
                               dataframe["STORE_NAME"].isNull()))
