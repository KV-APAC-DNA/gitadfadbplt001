...
def main(session: snowpark.Session,Param):
    try:
        ...
        if FileHeaderValidation == "1" and counter==0:
            ...
            if (val_file_extn==''xlsx'' or val_file_extn==''xls'') and ''Weekly Sales Report'' not in val_file_name and CURRENT_FILE[0:3]!="ROB" and CURRENT_FILE[0:2]!="SS" and "FSSI_Week" not in CURRENT_FILE:
