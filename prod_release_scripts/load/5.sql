...
--DROP TABLE SGPSDL_RAW.SDL_MDS_SG_PRODUCT_MAPPING;
create or replace TABLE SNAPOSESDL_RAW.SDL_MDS_SG_PRODUCT_MAPPING_test (
	ID NUMBER(18,0),
	MUID VARCHAR(36),
...
create or replace TABLE PROD_DNA_LOAD.SGPSDL_RAW.SDL_MDS_SG_PRODUCT_MAPPING_test CLONE PROD_DNA_LOAD.SNAPOSESDL_RAW.SDL_MDS_SG_PRODUCT_MAPPING_test;
