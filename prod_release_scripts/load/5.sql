...
create or replace TABLE SNAPOSESDL_RAW.SDL_MDS_SG_PRODUCT_MAPPING (
	ID NUMBER(18,0),
	MUID VARCHAR(36),
...
create or replace TABLE SGPSDL_RAW.SDL_MDS_SG_PRODUCT_MAPPING CLONE SNAPOSESDL_RAW.SDL_MDS_SG_PRODUCT_MAPPING;
