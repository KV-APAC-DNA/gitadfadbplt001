...
update META_RAW.HISTORICAL_OBJ_METADATA
set ISACTIVE = FALSE
where TARGET_SCHEMA in ('MYSSDL_RAW','MYSITG_INTEGRATION','MYSEDW_INTEGRATION','MYSWKS_INTEGRATION','SGPITG_INTEGRATION','SGPWKS_INTEGRATION','SGPEDW_INTEGRATION','SGPSDL_RAW');
