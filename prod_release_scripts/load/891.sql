...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        with SnowflakeFile.open(full_path,''rb'',require_scoped_url= False) as f:
            ...
            verticle_df = df2[[''MONTH:'',''WEEK:'',''ACCOUNT: SHM'',''Actual Delivery Date:'',''OSA Check Date'',''Encoded Report'',''REGION'',''TEAM LEADER:'',''BRANCH CODE:'',''Branch Size and Classification'',''MSL Classification'',''SKU CODE'']]
