...
def main(session: snowpark.Session,Param): 
    ...
    try :
        ...
        return error_message
        ';
CREATE OR REPLACE PROCEDURE CUSTOMERBRANDTREND_MONTLY_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
CREATE OR REPLACE PROCEDURE GT_SELLOUT_HYUNDAI_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
...
#----------------------------------------------------------------------------------------------------------------------------------------------
        ...
        error_message = f"Error: {str(e)}"
        return error_message;';
CREATE OR REPLACE PROCEDURE GT_SELLOUT_LOTTE_AK_PROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
...
#----------------------------------------------------------------------------------------------------------------------------------------------
        ...
        error_message = f"Error: {str(e)}"
        return error_message;';
CREATE OR REPLACE PROCEDURE GT_SELLOUT_LOTTE_LOGISTICS_YANG_JU_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('openpyxl==3.1.2','snowflake-snowpark-python==*')
...
#----------------------------------------------------------------------------------------------------------------------------------------------
        ...
        error_message = f"Error: {str(e)}"
        return error_message;';
CREATE OR REPLACE PROCEDURE J_KR_ECOMMERCE_EBAY_ETL_FRAMEWORK_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE J_KR_ECOMMERCE_TREXI_ETL_FRAMEWORK_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE J_TW_SELL_IN_FORECAST_TRANSACTION_DATA_INGESTION_BP_TARGET_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE J_TW_SELL_IN_FORECAST_TRANSACTION_DATA_INGESTION_BU_FORECAST_PROD_HIER_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE J_TW_SELL_IN_FORECAST_TRANSACTION_DATA_INGESTION_BU_FORECAST_SKU_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE KR_DADS_COUPANG_BPA_ADS_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
...
';
CREATE OR REPLACE PROCEDURE KR_DADS_COUPANG_PA_ADS_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
...
';
CREATE OR REPLACE PROCEDURE KR_DADS_COUPANG_PRICE_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE KR_DADS_COUPANG_SEARCH_KEYWORD_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE KR_DADS_NAVER_ADS_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
...
def main(session:snowpark.Session,Param):
    ...
    try:
        ...
        error_message = f"Error: {str(e)}"
        return error_message;';
CREATE OR REPLACE PROCEDURE KR_DADS_NAVER_GMV_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
';
CREATE OR REPLACE PROCEDURE KR_DADS_NAVER_KEYWORD_VOLUME_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
';
CREATE OR REPLACE PROCEDURE KR_DADS_NAVER_SEARCH_CHANNEL_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
';
CREATE OR REPLACE PROCEDURE KR_ECOM_DSTR_SELLOUT_STOCK_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('openpyxl==3.0.10','snowflake-snowpark-python==*')
...
def main(session: snowpark.Session,Param):
    try:
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE KR_GT_SELLOUT_HYUNDAI_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param): 
    ...
    try :
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE KR_GT_SELLOUT_JUNGSEOK_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param): 
    ...
    try :
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE KR_IL_DONG_HU_DI_S_DEOK_SEONG_SANG_SA_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param): 
    ...
    try :
        ...
        return error_message
        ';
CREATE OR REPLACE PROCEDURE KR_JU_HJ_LIFE_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param): 
    ...
    try :
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE KR_NACF_GT_SELLOUT_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        return error_message
';
CREATE OR REPLACE PROCEDURE KR_NH_GT_SELLOUT_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        return error_message
';
CREATE OR REPLACE PROCEDURE KR_NU_RI_ZON_GT_SELLOUT_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        return error_message
';
CREATE OR REPLACE PROCEDURE KR_OTC_SELLOUT_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        return error_message
';
CREATE OR REPLACE PROCEDURE KR_POS_ELAND_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
';
CREATE OR REPLACE PROCEDURE KR_POS_EMART_SSG_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
...
def main(session: snowpark.Session,Param): 
    try :
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE KR_POS_GS_SUPER_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param): 
    ...
    try :
        ...
        return error_message
        ';
CREATE OR REPLACE PROCEDURE KR_POS_HOME_PLUS_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        error_message = f"Error: {str(e)}"
        return error_message;';
CREATE OR REPLACE PROCEDURE KR_POS_LOHBS_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
';
CREATE OR REPLACE PROCEDURE KR_POS_LOTTE_MART_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        error_message = f"Error: {str(e)}"
        return error_message;';
CREATE OR REPLACE PROCEDURE KR_POS_LOTTE_SUPER_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
';
CREATE OR REPLACE PROCEDURE KR_POS_OLIVE_YOUNG_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
';
CREATE OR REPLACE PROCEDURE NA_KR_BO_YOUNG_JONG_HAP_LOGISTICS_GT_SELLOUT_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    try:
        ...
        return error_message
';
CREATE OR REPLACE PROCEDURE NA_KR_DAISO_GT_SELLOUT_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
...
def main(session: snowpark.Session,Param):
    try:
        ...
        return error_message
';
CREATE OR REPLACE PROCEDURE NA_KR_DA_IN_SANG_SA_GT_SELLOUT_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    try:
        ...
        return error_message
';
CREATE OR REPLACE PROCEDURE NA_KR_DONGBU_LSD_GT_SELLOUT_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    try:
        ...
        return error_message
';
CREATE OR REPLACE PROCEDURE NA_KR_DU_BAE_RO_YU_TONG_GT_SELLOUT_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    try:
        ...
        return error_message
';
CREATE OR REPLACE PROCEDURE NA_KR_GT_DAISO_PRICE_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    try:
        ...
        return error_message
';
CREATE OR REPLACE PROCEDURE NA_KR_GT_DPT_DAISO_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    try:
        ...
        return error_message
';
CREATE OR REPLACE PROCEDURE NA_KR_POS_COSTCO_INVRPT_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session): 
   ...
   #  SYSDATE AS UPDT_DTTM
    ...
    return "Success"
';
CREATE OR REPLACE PROCEDURE NA_KR_POS_COSTCO_VMIMST_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session): 
    ...
    return "Success"
';
CREATE OR REPLACE PROCEDURE NA_TRXN_IMS_INV_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE OTC_INV_1_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('openpyxl==3.1.2','snowflake-snowpark-python==*')
...
def main(session: snowpark.Session,Param): 
    ...
    try :
        ...
        return error_message
        ';
CREATE OR REPLACE PROCEDURE OTC_INV_2_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('openpyxl==3.1.2','snowflake-snowpark-python==*')
...
def main(session: snowpark.Session,Param): 
    ...
    try :
        ...
        return error_message
        ';
CREATE OR REPLACE PROCEDURE POP6_TH_POP_LISTS_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        ';
CREATE OR REPLACE PROCEDURE PRODUCT_MASTER_DAILY_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param): 
    ...
    try :
        ...
        return error_message
        ';
CREATE OR REPLACE PROCEDURE PRODUCT_MASTER_MONTHLY_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param): 
    ...
    try :
        ...
        return error_message
        ';
CREATE OR REPLACE PROCEDURE PRODUCT_MASTER_WEEKLY_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param): 
    ...
    try :
        ...
        return error_message
        ';
CREATE OR REPLACE PROCEDURE PRODUCT_RANKING_DAILY_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param): 
    ...
    try :
        ...
        return error_message
        ';
CREATE OR REPLACE PROCEDURE PRODUCT_RANKING_MONTHLY_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param): 
    ...
    try :
        ...
        return error_message
        ';
CREATE OR REPLACE PROCEDURE PRODUCT_RANKING_WEEKLY_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param): 
    ...
    try :
        ...
        return error_message
        ';
CREATE OR REPLACE PROCEDURE SDL_HK_IMS_VIVA_WING_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        return error_message
        ';
CREATE OR REPLACE PROCEDURE SDL_HK_POS_SCORECARD_MANNINGS_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
...
def main(session: snowpark.Session,Param):
   #Param=["J_J_30032024.xlsx","NTASDL_RAW.DEV_LOAD_STAGE_ADLS_hkg","dev/pos/Mannings","sdl_hk_pos_scorecard_mannings"]
    try:
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE SDL_KR_ECOM_COUPANG_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('openpyxl==3.1.2','snowflake-snowpark-python==*','xlrd==2.0.1')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE SDL_KR_ECOM_NAVER_SELLOUT_TEMP_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE SDL_KR_SFMC_NAVER_DATA_ADDITIONAL_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    ';
CREATE OR REPLACE PROCEDURE SDL_KR_SFMC_NAVER_DATA_ADDITIONAL_PREPROCESSSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
       ...
       # Concatenate the columns
        ...
        return error_message
        ';
CREATE OR REPLACE PROCEDURE SDL_POP6_TH_PRODUCT_LISTS_ALLOCATION_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
       ...
       # Concatenate the columns
        ...
        return error_message
        ';
CREATE OR REPLACE PROCEDURE SDL_TW_AS_WATSONS_INVENTORY_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
# Define the list of column names
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE SDL_TW_AS_WATSONS_INVENTORY_PREPROCESSING("PARAM" VARIANT)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
# Define the list of column names
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE SDL_TW_IMS_DSTR_STD_CUSTOMER_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        return error_message
        ';
CREATE OR REPLACE PROCEDURE SDL_TW_IMS_DSTR_STD_SEL_OUT_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        return error_message
        ';
CREATE OR REPLACE PROCEDURE SDL_TW_IMS_DSTR_STD_STOCK_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        return error_message
        ';
CREATE OR REPLACE PROCEDURE SEARCH_KEYWORD_BY_CATEGORY_DAILY_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param): 
    ...
    try :
        ...
        return error_message
        ';
CREATE OR REPLACE PROCEDURE SEARCH_KEYWORD_BY_CATEGORY_MONTHLY_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param): 
    ...
    try :
        ...
        return error_message
        ';
CREATE OR REPLACE PROCEDURE SEARCH_KEYWORD_BY_CATEGORY_WEEKLY_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param): 
    ...
    try :
        ...
        return error_message
        ';
CREATE OR REPLACE PROCEDURE SEARCH_KEYWORD_BY_PRODUCT_DAILY_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param): 
    ...
    try :
        ...
        return error_message
        ';
CREATE OR REPLACE PROCEDURE SEARCH_KEYWORD_BY_PRODUCT_MONTHLY_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param): 
    ...
    try :
        ...
        return error_message
        ';
CREATE OR REPLACE PROCEDURE SEARCH_KEYWORD_BY_PRODUCT_WEEKLY_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param): 
    ...
    try :
        ...
        return error_message
        ';
CREATE OR REPLACE PROCEDURE TWSI_TARGET_INGESTION_PREPROCESING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE TW_CRM_CHILDERN_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    ';
CREATE OR REPLACE PROCEDURE TW_CRM_CONSUMER_MASTER_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('openpyxl==3.0.10','snowflake-snowpark-python==*','unidecode==1.2.0')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        return error_message;
';
CREATE OR REPLACE PROCEDURE TW_CRM_INVOICE_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE TW_CRM_REDEMPTION_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE TW_POS_711_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE TW_POS_CARREFOUR_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.8'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        dataframe = dataframe.with_column("crt_dttm",lit(datetime.now(pytz.timezone("Asia/Singapore")).strftime("%Y-%m-%d %H:%M:%S")))
        # Creating copy of the Dataframe
        final_df = dataframe.select("pos_date","gln","vendor","store_no","store_name","product_code","product_name_english","product_name_chinese","ean_code","amount","qty","crt_dttm","upd_dttm")
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE TW_POS_COSMED_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        final_df = final_df.select("PRODUCT_CO","PRODUCT_NM","WK1_STRT_DT","WK1_END_DT","WK1_QUANTITY","WK2_STRT_DT","WK2_END_DT","WK2_QUANTITY","WK3_STRT_DT","WK3_END_DT","WK3_QUANTITY","WK4_STRT_DT","WK4_END_DT","WK4_QUANTITY","crt_dttm","upd_dttm")
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE TW_POS_EC_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        # # Creating copy of the Dataframe
        final_df = dataframe.select("CUSTOMER_EC_PLATFOM", "POS_DATE", "PRODUCT_CODE", "BRAND", "PRODUCT_NAME","QTY","SELLING_AMT_BEFORE_TAX","CRT_DTTM","UPD_DTTM" )
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE TW_POS_POYE_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        final_df = dataframe.select("VENDOR_CODE", "DEPARTMENT", "CATEGORY_SMALL", "CUSTOMER_PRODUCT_CODE", "EAN_CODE","PRODUCT_DESCRIPTION","SELLING_QTY","SELLING_AMT","INVENTORY","CHANGE_CODE",\\
                                    "CHANGE_DATE","START_DATE","END_DATE","CRT_DTTM","UPD_DTTM" )
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE TW_POS_PXCIVILIA_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE TW_POS_RT_MART_PREPROCESING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    ...
    try:
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE TW_POS_WATSON_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    #Param=["TW_POS_Watsons_RawData_20240418_20240418.csv","NTASDL_RAW.DEV_LOAD_STAGE_ADLS_TWN","dev/pos/transaction/watsons/","sdl_tw_pos_watson_store"]
    try:
        file_name       = Param[0]
        stage_name      = Param[1]
        temp_stage_path = Param[2]
        ...
        df_schema = StructType([
                ...
                StructField("product_description", StringType(), True),
                StructField("selling_qty", StringType(), True),
                StructField("selling_amt", StringType(), True),
                StructField("department", StringType(), True)
        ...
        # 
        df = df.dropna(subset=["selling_qty"])
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE TW_SFMC_BOUNCE_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param): 
    ...
    try:
        ...
        #Param=[''TW_Action_Bounce_20240428.csv'',''NTASDL_RAW.DEV_LOAD_STAGE_ADLS_TWN'',''dev/SFMC/transaction/tw_action_bounce/'',''SDL_TW_SFMC_BOUNCE_DATA'']
        ...
        # Load Data to the target table
        dataframe.write.mode("append").save_as_table(stage_name.split(".")[0]+"."+target_table)
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE TW_SFMC_CLICK_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param): 
    ...
    try:
        ...
        #Param=[''TW_Action_Click_20240429.csv'',''NTASDL_RAW.DEV_LOAD_STAGE_ADLS_TWN'',''dev/SFMC/transaction/tw_action_click/'',''SDL_TW_SFMC_CLICK_DATA'']
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE TW_SFMC_COMPLAINT_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param): 
    ...
    try:
        ...
        #Param=[''TW_Action_Complaint_20240428.csv'',''NTASDL_RAW.DEV_LOAD_STAGE_ADLS_TWN'',''dev/SFMC/transaction/tw_action_complaint/'',''SDL_TW_SFMC_COMPLAINT_DATA'']
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE TW_SFMC_OPEN_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param): 
    ...
    try:
        ...
        #Param=[''TW_Action_Open_20240430.csv'',''NTASDL_RAW.DEV_LOAD_STAGE_ADLS_TWN'',''dev/SFMC/transaction/tw_sfmc_open/'',''SDL_TW_SFMC_OPEN_DATA'']
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE TW_SFMC_SENT_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param): 
    ...
    try:
        ...
        #Param=[''TW_Action_Sent_20240501.csv'',''NTASDL_RAW.DEV_LOAD_STAGE_ADLS_TWN'',''dev/SFMC/transaction/tw_sfmc_sent/'',''SDL_TW_SFMC_SENT_DATA'']
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE TW_SFMC_UNSUBSCRIBE_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param): 
    ...
    try:
        ...
        #Param=[''TW_Action_Unsubscribe_20240502.csv'',''NTASDL_RAW.DEV_LOAD_STAGE_ADLS_TWN'',''dev/SFMC/transaction/tw_action_unsubscribe/'',''SDL_TW_SFMC_UNSUBSCRIBE_DATA'']
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE TW_STRATEGIC_CUSTOMER_HIERARCHY_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param):
    #Param=["Strategic_Customer_20240419.csv","NTASDL_RAW.DEV_LOAD_STAGE_ADLS_TWN","dev/taiwan_forecast/master/","sdl_tw_strategic_cust_hier"]
    try:
        file_name       = Param[0]
        stage_name      = Param[1]
        temp_stage_path = Param[2]
        ...
        df_schema = StructType([
                StructField("Strategy_Customer_Hierachy_name", StringType(), True),
                StructField("Strategy_Customer_Hierachy_Code", StringType(), True),
                StructField("Customer_Code", StringType(), True),
                StructField("Customer_Name", StringType(), True)
        ...
        snowdf= df.select(
                    ...
                    "Strategy_Customer_Hierachy_Code",
                    "Customer_Code",
                    "Customer_Name",
                    "filename",
                    "run_id",
