CREATE OR REPLACE PROCEDURE PROD_DNA_LOAD.ASPSDL_RAW.FILE_VALIDATION_1122_bkp("PARAM" ARRAY)
...
def main(session: snowpark.Session,Param):
    try:
        ...
        if index.lower() == "last":
            ...
            extracted_filename=CURRENT_FILE.split(".")[0]
        elif index =="name_mmm_yy.csv":
            extracted_filename = processed_file_name.rsplit("_", 2)[0]   
