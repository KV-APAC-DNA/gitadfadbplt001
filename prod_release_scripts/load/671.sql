CREATE OR REPLACE PROCEDURE PROD_DNA_LOAD.PCFSDL_RAW.ANZ_PERENSO_FOODSTUFF_FSSI_PREPROCESSING("PARAM" ARRAY)
...
def main(session: snowpark.Session,Param): 
    ...
    try:
        ...
        #Param=[''FSSI Week 18 2024.xls'',''PCFSDL_RAW.DEV_LOAD_STAGE_ADLS'',''dev/ap_perenso/transaction/weekly_load/foodstuff/fssi_week/'',''SDL_PERENSO_FSSI_SALES'']
        ...
        with SnowflakeFile.open(full_path, "rb", require_scoped_url = False) as f:
            ...
            df_pandas=pd.read_excel(f,header=6,names=header_names,dtype=str)
        ...
        dataframe = dataframe.filter((dataframe["SHIP_TO_STORE"] != "Result") & dataframe["ARTICLE"].isNotNull() &   dataframe["ARTICLE_DESCRIPTION"].isNotNull() & dataframe["OLD_ARTICLE_NUM"].isNotNull() & dataframe["EAN"].isNotNull() & dataframe["GROSS_WEIGHT"].isNotNull() & dataframe["SHIP_TO_STORE"].isNotNull() & dataframe["STORE_NAME"].isNotNull())
        ...
        new_dataframe = dataframe.limit(total_rows - 1)
        

        # Creating Final Dataframe
        final_df = new_dataframe.alias("final_df")
