UPDATE PROD_DNA_LOAD.META_RAW.PARAMETERS SET PARAMETER_VALUE='otif/transaction/' WHERE PARAMETR_GROUP_ID=2001 AND PARAMETER_NAME='landing_file_path' and PARAMETER_ID=25002;
UPDATE PROD_DNA_LOAD.META_RAW.PARAMETERS SET PARAMETER_VALUE='OTIF_Server' WHERE PARAMETR_GROUP_ID=2001 AND PARAMETER_NAME='decide_source' and PARAMETER_ID=25007;
UPDATE PROD_DNA_LOAD.META_RAW.PARAMETERS SET PARAMETER_VALUE='ASPSDL_RAW' WHERE PARAMETR_GROUP_ID=2001 AND PARAMETER_NAME='target_schema' and PARAMETER_ID=25005;
...
UPDATE PROD_DNA_LOAD.META_RAW.PROCESS SET SOURCE_ID=5 WHERE PROCESS_ID=2001 AND PARAMETR_GROUP_ID=2001;
