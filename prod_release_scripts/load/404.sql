...
CREATE OR REPLACE PROCEDURE NTASDL_RAW.TW_POS_CARREFOUR_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.8'
PACKAGES = ('snowflake-snowpark-python')
...
CREATE OR REPLACE PROCEDURE NTASDL_RAW.TW_POS_COSMED_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
CREATE OR REPLACE PROCEDURE NTASDL_RAW.TW_POS_EC_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
CREATE OR REPLACE PROCEDURE NTASDL_RAW.TW_POS_POYE_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
CREATE OR REPLACE PROCEDURE NTASDL_RAW.TW_POS_PXCIVILIA_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
CREATE OR REPLACE PROCEDURE NTASDL_RAW.TW_POS_RT_MART_PREPROCESING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
CREATE OR REPLACE PROCEDURE NTASDL_RAW.TW_POS_WATSON_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
CREATE OR REPLACE PROCEDURE NTASDL_RAW.TW_SFMC_BOUNCE_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
CREATE OR REPLACE PROCEDURE NTASDL_RAW.TW_SFMC_CLICK_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
CREATE OR REPLACE PROCEDURE NTASDL_RAW.TW_SFMC_COMPLAINT_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
def main(session: snowpark.Session,Param): 
    ...
    try:
        ...
        error_message = f"Error: {str(e)}"
        return error_message';
CREATE OR REPLACE PROCEDURE NTASDL_RAW.TW_SFMC_OPEN_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
CREATE OR REPLACE PROCEDURE NTASDL_RAW.TW_SFMC_SENT_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
CREATE OR REPLACE PROCEDURE NTASDL_RAW.TW_SFMC_UNSUBSCRIBE_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
CREATE OR REPLACE PROCEDURE NTASDL_RAW.TW_STRATEGIC_CUSTOMER_HIERARCHY_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
