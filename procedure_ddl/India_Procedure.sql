...
CREATE OR REPLACE PROCEDURE DEV_DNA_LOAD.INDSDL_RAW.IN_RETAILER_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
CREATE OR REPLACE PROCEDURE DEV_DNA_LOAD.INDSDL_RAW.IN_RETAILER_ROUTE_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
CREATE OR REPLACE PROCEDURE DEV_DNA_LOAD.INDSDL_RAW.IN_SALESMAN_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
CREATE OR REPLACE PROCEDURE DEV_DNA_LOAD.INDSDL_RAW.IN_SALESMAN_ROUTE_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
CREATE OR REPLACE PROCEDURE DEV_DNA_LOAD.INDSDL_RAW.IN_ROUTE_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
