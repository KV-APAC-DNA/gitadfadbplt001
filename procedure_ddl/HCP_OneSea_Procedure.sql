...
USE SCHEMA HCPOSESDL_RAW;


CREATE OR REPLACE PROCEDURE HCPOSESDL_RAW.HCP_OSEA_ICONNECTUSERS_PREPROCESSING("PARAM" ARRAY)
...
CREATE OR REPLACE PROCEDURE HCPOSESDL_RAW.HCP_OSEA_HOLIDAY_LIST_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
...
CREATE OR REPLACE PROCEDURE HCPOSESDL_RAW.HCP_OSEA_SALESFORCE_LOAD_PREPROCESSING("PARAM" ARRAY)
RETURNS VARCHAR(16777216)
LANGUAGE PYTHON
RUNTIME_VERSION = '3.11'
PACKAGES = ('snowflake-snowpark-python')
