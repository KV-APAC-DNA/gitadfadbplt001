...
--DROP TABLE SNAPNTAWKS_INTEGRATION.prod_hier_data_new;
CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.PROD_HIER_DATA_NEW		--// CREATE TABLE IF NOT EXISTS  // CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.prod_hier_data_new
(
...
;
--DROP TABLE SNAPNTAWKS_INTEGRATION.wks_edw_customer_attr_flat_dim;
CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.WKS_EDW_CUSTOMER_ATTR_FLAT_DIM		--// CREATE TABLE IF NOT EXISTS  // CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.wks_edw_customer_attr_flat_dim
(
...
;
--DROP TABLE SNAPNTAWKS_INTEGRATION.wks_edw_perfect_store_data_reformat;
CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.WKS_EDW_PERFECT_STORE_DATA_REFORMAT		--// CREATE TABLE IF NOT EXISTS  // CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.wks_edw_perfect_store_data_reformat
(
	dataset VARCHAR(128)  		--//  ENCODE lzo
	,customerid VARCHAR(255)  		--//  ENCODE lzo
	,salespersonid VARCHAR(255)  		--//  ENCODE lzo
...
;
--DROP TABLE SNAPNTAWKS_INTEGRATION.wks_edw_perfect_store_hash;
CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.WKS_EDW_PERFECT_STORE_HASH		--// CREATE TABLE IF NOT EXISTS  // CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.wks_edw_perfect_store_hash
(
...
CLUSTER BY(hashkey)
;
--DROP TABLE SNAPNTAWKS_INTEGRATION.wks_edw_perfect_store_kpi_agg_wt_mnth;
CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.WKS_EDW_PERFECT_STORE_KPI_AGG_WT_MNTH		--// CREATE TABLE IF NOT EXISTS  // CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.wks_edw_perfect_store_kpi_agg_wt_mnth
(
	country VARCHAR(200)  		--//  ENCODE lzo
	,customerid VARCHAR(255)  		--//  ENCODE lzo
...
;
--DROP TABLE SNAPNTAWKS_INTEGRATION.wks_edw_perfect_store_kpi_agg_wt_mnth_cname;
CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.WKS_EDW_PERFECT_STORE_KPI_AGG_WT_MNTH_CNAME		--// CREATE TABLE IF NOT EXISTS  // CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.wks_edw_perfect_store_kpi_agg_wt_mnth_cname
(
	country VARCHAR(200)  		--//  ENCODE lzo
	,customername VARCHAR(771)  		--//  ENCODE lzo
	,scheduledmonth VARCHAR(14)  		--//  ENCODE lzo
...
;
--DROP TABLE SNAPNTAWKS_INTEGRATION.wks_edw_perfect_store_kpi_rebased_wt_mnth;
CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.WKS_EDW_PERFECT_STORE_KPI_REBASED_WT_MNTH		--// CREATE TABLE IF NOT EXISTS  // CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.wks_edw_perfect_store_kpi_rebased_wt_mnth
(
	country VARCHAR(200)  		--//  ENCODE lzo
	,customerid VARCHAR(255)  		--//  ENCODE lzo
	,scheduledmonth VARCHAR(14)  		--//  ENCODE lzo
...
;
--DROP TABLE SNAPNTAWKS_INTEGRATION.wks_edw_perfect_store_kpi_rebased_wt_mnth_cname;
CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.WKS_EDW_PERFECT_STORE_KPI_REBASED_WT_MNTH_CNAME		--// CREATE TABLE IF NOT EXISTS  // CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.wks_edw_perfect_store_kpi_rebased_wt_mnth_cname
(
	country VARCHAR(200)  		--//  ENCODE lzo
	,customername VARCHAR(771)  		--//  ENCODE lzo
	,scheduledmonth VARCHAR(14)  		--//  ENCODE lzo
...
;
--DROP TABLE SNAPNTAWKS_INTEGRATION.wks_edw_perfect_store_kpi_wt_mnth;
CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.WKS_EDW_PERFECT_STORE_KPI_WT_MNTH		--// CREATE TABLE IF NOT EXISTS  // CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.wks_edw_perfect_store_kpi_wt_mnth
(
	country VARCHAR(200)  		--//  ENCODE lzo
	,customerid VARCHAR(255)  		--//  ENCODE lzo
	,scheduledmonth VARCHAR(14)  		--//  ENCODE lzo
...
;
--DROP TABLE SNAPNTAWKS_INTEGRATION.wks_edw_perfect_store_kpi_wt_mnth_cname;
CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.WKS_EDW_PERFECT_STORE_KPI_WT_MNTH_CNAME		--// CREATE TABLE IF NOT EXISTS  // CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.wks_edw_perfect_store_kpi_wt_mnth_cname
(
	country VARCHAR(200)  		--//  ENCODE lzo
	,customername VARCHAR(771)  		--//  ENCODE lzo
	,scheduledmonth VARCHAR(14)  		--//  ENCODE lzo
...
;
--DROP TABLE SNAPNTAWKS_INTEGRATION.wks_edw_product_attr_dim;
CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.WKS_EDW_PRODUCT_ATTR_DIM		--// CREATE TABLE IF NOT EXISTS  // CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.wks_edw_product_attr_dim
(
...
;
--DROP TABLE SNAPNTAWKS_INTEGRATION.wks_hk_inventory_health_analysis_propagation;
CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.WKS_HK_INVENTORY_HEALTH_ANALYSIS_PROPAGATION		--// CREATE TABLE IF NOT EXISTS  // CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.wks_hk_inventory_health_analysis_propagation
(
...
;
--DROP TABLE SNAPNTAWKS_INTEGRATION.wks_hk_inventory_health_analysis_propagation_final;
CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.WKS_HK_INVENTORY_HEALTH_ANALYSIS_PROPAGATION_FINAL		--// CREATE TABLE IF NOT EXISTS  // CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.wks_hk_inventory_health_analysis_propagation_final
(
	cal_year numeric(18,0)		--//  ENCODE az64 // INTEGER  
	,cal_qrtr_no VARCHAR(11)  		--//  ENCODE lzo
	,cal_mnth_id VARCHAR(23)  		--//  ENCODE lzo
...
;
--DROP TABLE SNAPNTAWKS_INTEGRATION.wks_perfect_store_sos_soa_custid_ind;
CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.WKS_PERFECT_STORE_SOS_SOA_CUSTID_IND		--// CREATE TABLE IF NOT EXISTS  // CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.wks_perfect_store_sos_soa_custid_ind
(
	hashkey VARCHAR(32)  		--//  ENCODE lzo
	,hash_row numeric(38,0)		--//  ENCODE az64 // BIGINT  
	,dataset VARCHAR(128)  		--//  ENCODE lzo
...
CLUSTER BY(hashkey)
;
--DROP TABLE SNAPNTAWKS_INTEGRATION.wks_perfect_store_sos_soa_mnth;
CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.WKS_PERFECT_STORE_SOS_SOA_MNTH		--// CREATE TABLE IF NOT EXISTS  // CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.wks_perfect_store_sos_soa_mnth
(
	hashkey VARCHAR(32)  		--//  ENCODE lzo
	,hash_row numeric(38,0)		--//  ENCODE az64 // BIGINT  
	,dataset VARCHAR(128)  		--//  ENCODE lzo
...
CLUSTER BY(hashkey)
;
--DROP TABLE SNAPNTAWKS_INTEGRATION.wks_sotp_propagation_hash;
CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.WKS_SOTP_PROPAGATION_HASH		--// CREATE TABLE IF NOT EXISTS  // CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.wks_sotp_propagation_hash
(
	dataset VARCHAR(49)
	,country VARCHAR(200)
...
CLUSTER BY(hashkey)
		...
		--// 	)
;		--// ;
--DROP TABLE SNAPNTAWKS_INTEGRATION.wks_tw_inventory_health_analysis_propagation;
CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.WKS_TW_INVENTORY_HEALTH_ANALYSIS_PROPAGATION		--// CREATE TABLE IF NOT EXISTS  // CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.wks_tw_inventory_health_analysis_propagation
(
	cal_year numeric(18,0)		--//  ENCODE az64 // INTEGER  
	,cal_qrtr_no VARCHAR(11)  		--//  ENCODE lzo
...
;
--DROP TABLE SNAPNTAWKS_INTEGRATION.wks_tw_inventory_health_analysis_propagation_final;
CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.WKS_TW_INVENTORY_HEALTH_ANALYSIS_PROPAGATION_FINAL		--// CREATE TABLE IF NOT EXISTS  // CREATE OR REPLACE TABLE SNAPNTAWKS_INTEGRATION.wks_tw_inventory_health_analysis_propagation_final
(
	cal_year numeric(18,0)		--//  ENCODE az64 // INTEGER  
	,cal_qrtr_no VARCHAR(11)  		--//  ENCODE lzo
	,cal_mnth_id VARCHAR(11)  		--//  ENCODE lzo
